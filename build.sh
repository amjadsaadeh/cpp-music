...
conan install --build=missing -s build_type=$BUILD_TYPE --profile:host=default --profile:build=default -of $BUILD_DIR -if $BUILD_DIR -o cppmusic:require_cmake=False .
